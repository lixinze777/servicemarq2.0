...
class Ner(BertForTokenClassification):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,valid_ids=None,attention_mask_label=None):
        ...
        valid_output = torch.zeros(batch_size,max_len,feat_dim,dtype=torch.float32,device='cuda:0')
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["O", "B-MISC", "I-MISC",  "B-PER", "I-PER", "E-PER", "S-PER", "B-ORG", "I-ORG", "E-ORG", "S-ORG", "B-LOC", "I-LOC", "E-LOC", "S-LOC", "B-ROLE", "I-ROLE", "E-ROLE", "ROLE", "BI-ROLE", "[CLS]", "[SEP]"]
