...
data_folder = '/home/wing.nus/xinze/journal-mining/journal_crawl/post_processing/line_ner'
corpus: Corpus = ColumnCorpus(data_folder, columns, train_file = 'datatrain.txt', test_file = 'datatest.txt', dev_file = 'datadev.txt')
print(corpus)
